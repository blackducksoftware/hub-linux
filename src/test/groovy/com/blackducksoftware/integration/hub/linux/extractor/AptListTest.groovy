...
class AptListTest {
    ...
    void testExtractingAptFile1() {
        extractAptComponentsFromFile('ubuntu_apt_package_list_1.txt', 4284,'python3-commandnotfound','0.3ubuntu12')
    }

    @Test
    void testExtractingAptFile2() {
        extractAptComponentsFromFile('ubuntu_apt_package_list_2.txt', 4146,'ntp','1:4.2.6.p5+dfsg-3ubuntu2.14.04.10')
    }

    @Test
    void testExtractingAptFile3() {
        extractAptComponentsFromFile('ubuntu_apt_package_list_3.txt', 3786,'lsb-base','4.1+Debian11ubuntu6.1')
    }
